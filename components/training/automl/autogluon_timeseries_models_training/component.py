...
def autogluon_timeseries_models_training(
    ...
    Args:
        ...
        preset: Training quality tier. ``"speed"`` (default), ``"balanced"``, or
            ``"deep"`` (up to six hours with AutoGluon ``high_quality``).
    ...
    with status:
        ...
        PRESET_AG_NAMES = {"speed": "fast_training", "balanced": "medium_quality", "deep": "high_quality"}
        PRESET_TIME_LIMITS = {"speed": 10 * 60, "balanced": 60 * 60, "deep": 360 * 60}
