...
class TestAutogluonModelsTrainingUnitTests:
    ...
    @mock.patch("pandas.read_csv")
    @mock.patch("autogluon.tabular.TabularPredictor")
    def test_evaluation_mode_user_provided_stored_in_metadata(self, mock_predictor_class, mock_read_csv, tmp_path):
        """evaluation_mode='user-provided' is accepted and stored in metadata."""
        mock_predictor = mock.MagicMock()
        mock_predictor_clone = mock.MagicMock()
        mock_predictor_class.return_value.fit.return_value = mock_predictor
        mock_predictor.clone.return_value = mock_predictor_clone
    ...
    @mock.patch("pandas.read_csv")
    @mock.patch("autogluon.tabular.TabularPredictor")
    def test_evaluation_mode_auto_split_stored_in_metadata(self, mock_predictor_class, mock_read_csv, tmp_path):
        """evaluation_mode='auto-split' is accepted and stored in metadata."""
        mock_predictor = mock.MagicMock()
        mock_predictor_clone = mock.MagicMock()
        mock_predictor_class.return_value.fit.return_value = mock_predictor
        mock_predictor.clone.return_value = mock_predictor_clone
    ...
    @mock.patch("pandas.read_csv")
    @mock.patch("autogluon.tabular.TabularPredictor")
    def test_evaluation_mode_defaults_to_auto_split(self, mock_predictor_class, mock_read_csv, tmp_path):
        """When evaluation_mode is not provided, it defaults to 'auto-split'."""
        mock_predictor = mock.MagicMock()
        mock_predictor_clone = mock.MagicMock()
        mock_predictor_class.return_value.fit.return_value = mock_predictor
        mock_predictor.clone.return_value = mock_predictor_clone
        ...
        # Call without evaluation_mode parameter - should default to "auto-split"
        autogluon_models_training.python_func(
            label_column="target",
            task_type="regression",
            top_n=1,
    ...
    @mock.patch("pandas.read_csv")
    @mock.patch("autogluon.tabular.TabularPredictor")
    def test_evaluation_mode_metadata_structure(self, mock_predictor_class, mock_read_csv, tmp_path):
        """evaluation_mode is stored in the correct metadata structure alongside sampling and split configs."""
        mock_predictor = mock.MagicMock()
        mock_predictor_clone = mock.MagicMock()
        mock_predictor_class.return_value.fit.return_value = mock_predictor
        mock_predictor.clone.return_value = mock_predictor_clone
